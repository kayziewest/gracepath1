...
<header class="header" style="background-color: #ffffff  repeat-x; background-size: 100% 100%; ">
    ...
    <nav class="navbar navbar-static-top" role="navigation" style="background-color: #38B5ED;  repeat-x; background-size: 100% 100%; border-bottom:1px solid #CCC">
            ...
            <ul class="nav navbar-nav">
               ...
               <!-- <li class="dropdown notifications-menu">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style=" padding-top: 1px; ">
