                                ...
                                <form role="form" method="post" action="<?php echo base_url() ?>app/declared_receipt/save" onSubmit="return confirm('Are you sure you want to save?');">
                                    ...
                                    <table width="100%" cellpadding="2" cellspacing="2">
                                        ...
                                        <tr>
                                            <td>Sub Total</td>
                                            <td>
                                                <input onKeyUp="return compute()" onBlur="return validate_sub(this.value)" onkeypress="return isNumberKey(event)" value="<?php echo $ORList->subtotal ?>" name="subtotal" id="subtotal" class="form-control input-sm" type="text" placeholder="Sub Total" style="width: 250px;" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Discount</td>
                                            <td>
                                                <input onKeyUp="return compute()" onBlur="return validate_discount(this.value)" onkeypress="return isNumberKey(event)" value="<?php echo $ORList->discount ?>" name="discount" id="discount" class="form-control input-sm" type="text" placeholder="Discount" style="width: 250px;" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Total Amount</td>
