                                        ...
                                        <div class="tab-pane active" id="general_information">
                                            ...
                                            <form role="form" method="post" action="<?php echo base_url() ?>app/user/edit" onSubmit="return confirm('Are you sure you want to save?');">
                                                <table cellpadding="3" cellspacing="3" width="100%">
                                                    <tr>
                                                        <td colspan="2">Required fields = <font color="#FF0000">*</font>
                                                        </td>
                                                    </tr>
                                                    <tR>
                                                        <td colspan="2">
                                                    ...
                                                    <tr>
                                                        <td width="12%">Title <font color="#FF0000">*</font>
                                                        </td>
                                                        <td width="88%">
                                                    ...
                                                    <tr>
                                                        <td width="12%">Last Name <font color="#FF0000">*</font>
                                                        </td>
                                                        <td width="88%">
                                                    ...
                                                    <tr>
                                                        <td>First Name <font color="#FF0000">*</font>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>Middle Name <font color="#FF0000">*</font>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>Birthday <font color="#FF0000">*</font>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td width="12%">Department <font color="#FF0000">*</font>
                                                        </td>
                                                        <td width="88%">
                                                    ...
                                                    <tr>
                                                        <td width="12%">Designation <font color="#FF0000">*</font>
                                                        </td>
                                                        <td width="88%">
                                                    ...
                                                    <tr>
                                                        <td width="12%">User Role <font color="#FF0000">*</font>
                                                        </td>
                                                        <td width="88%">
                                                    ...
                                                    <tr>
                                                        <td width="14%">Username <font color="#FF0000">*</font>
                                                        </td>
                                                        <td width="86%">
                                        ...
                                        <div class="tab-pane" id="changePAssword">
                                            <form role="form" method="post" name="frmchangepassword" id="frmchangepassword">
                                                ...
                                                <table cellpadding="3" cellspacing="3" width="100%">
                                                    ...
                                                    <tr>
                                                        <td width="12%">New Password <font color="#FF0000">*</font>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td width="12%">Re-type Password <font color="#FF0000">*</font>
                                                        </td>
