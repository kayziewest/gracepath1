									...
									<div class="tab-pane" id="tab_2">
										...
										<div class="form-group">
											...
											<select name="paymentType" id="paymentType" class="form-control input-sm" style="width:250px;" onChange="setTitle(this.value)">
												...
												<option value="cash" <?php if ($headerInv->payment_type == "cash") {
																			echo "selected";
																		} ?>>Cash</option>
												<option value="credit" <?php if ($headerInv->payment_type == "credit") {
																			echo "selected";
																		} ?>>Credit</option>
												<option value="insurance" <?php if ($headerInv->payment_type == "insurance") {
																				echo "selected";
