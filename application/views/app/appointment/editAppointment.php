                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <fieldset>
                                        ...
                                        <table cellpadding="3" cellspacing="3" width="100%">
                                            ...
                                            <tr>
                                                <td width="12%">Date Appointment <font color="#FF0000">*</font>
                                                </td>
                                                <td width="88%">
                                            ...
                                            <tr>
                                                <td width="12%">Time Appointment <font color="#FF0000">*</font>
                                                </td>
                                                <td width="88%">
                                                    <select name="appHour" id="appHour" class="form-controls input-sm" style="width: 100px;">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $hh; ?>" <?php if ($patientInfo->appHour == $hh) {
                                                                                                    echo "selected";
                                                                                                } ?>><?php echo $hh; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    ...
                                                    <select name="appMinutes" id="appMinutes" class="form-controls input-sm" style="width: 100px;">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $mm; ?>" <?php if ($patientInfo->appMinutes == $mm) {
                                                                                                    echo "selected";
                                                                                                } ?>><?php echo $mm; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    ...
                                                    <select name="appAMPM" id="appAMPM" class="form-controls input-sm" style="width: 100px;">
                                                        ...
                                                        <option value="AM" <?php if ($patientInfo->appAMPM == "AM") {
                                                                                echo "selected";
                                                                            } ?>>AM</option>
                                                        <option value="PM" <?php if ($patientInfo->appAMPM == "PM") {
                                                                                echo "selected";
                                                                            } ?>>PM</option>
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                <td width="12%">Consultant Doctor <font color="#FF0000">*</font>
                                                </td>
                                                <td width="88%">
                                            ...
                                            <tr>
                                                <td width="12%">Appointment Reason <font color="#FF0000">*</font>
                                                </td>
                                                <td width="88%">
