                                ...
                                <form role="form" method="post" action="<?php echo base_url() ?>app/roles/edit" onSubmit="return confirm('Are you sure you want to save?');">
                                    ...
                                    <!--<div class="form-group">
                                            ...
                                            <select name="module" id="module" class="form-control input-sm" style="width: 350px;" required>
                                            	...
                                            	<option value="administrator" <?php if ($roles->module == "administrator") {
                                                                                    echo "selected";
                                                                                } ?>>Administrator Module</option>
                                                <option value="doctor" <?php if ($roles->module == "doctor") {
                                                                            echo "selected";
                                                                        } ?>>Doctor Module</option>
                                                <option value="helpdesk" <?php if ($roles->module == "helpdesk") {
                                                                                echo "selected";
                                                                            } ?>>Help Desk Module</option>
                                                <option value="nursing" <?php if ($roles->module == "nursing") {
                                                                            echo "selected";
                                                                        } ?>>Nursing Module</option>
                                                <option value="billing" <?php if ($roles->module == "billing") {
                                                                            echo "selected";
                                                                        } ?>>Billing Module</option>
                                            </select>
                                        </div>-->
