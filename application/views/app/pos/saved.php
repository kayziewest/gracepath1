					...
					<div class="box box-primary">
						<div class="box-body">
							...
							<?php if ($OR_number == "-") { ?>
								...
								<a class="btn btn-app" onClick="alert('Invoice hasnt been marked as paid so Print Receipt is disabled.');"><i class="fa fa-print"></i> Print Receipt</a>
							<?php } else { ?>
								<a class="btn btn-app" onClick="alert('Invoice  already has receipt.You cannot modify this transaction.');"><i class="fa fa-plus"></i> Add Item</a>
								<a class="btn btn-app" onClick="alert('Invoice already  has receipt.You cannot modify this transaction.');"><i class="fa fa-hand-o-down"></i> 1-Click Billed</a>
								<a class="btn btn-app" onClick="alert('Invoice already  has receipt.You cannot modify this transaction.');"><i class="fa fa-save"></i> Save</a>
								<a class="btn btn-app" onClick="alert('Invoice already has  receipt.You cannot modify this transaction.');"><i class="fa fa-credit-card"></i> Payment</a>
								<a class="btn btn-app" href="<?php echo base_url() ?>app/opd/printInv/<?php echo $getOPDPatient->IO_ID ?>/<?php echo $patientInfo->patient_no ?>/<?php echo $headerInv->invoice_no ?>" target="_blank"><i class="fa fa-print"></i> Print Invoice</a>
